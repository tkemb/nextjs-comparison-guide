...
function CategoryCard({ name, slug, documentId, imageUrl }) {
  ...
  return (
    <Link href={`/category/${slug || documentId}`} className="group">
      <div className="relative bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-200 overflow-hidden aspect-square group-hover:scale-105">
